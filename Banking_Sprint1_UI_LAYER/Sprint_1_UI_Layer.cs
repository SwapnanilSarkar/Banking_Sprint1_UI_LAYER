            ...
            switch (choice)
            {
                case 1:
                    ...
                    if (n==1)
                    {
                        ...
                        Console.WriteLine("Bank details has been saved");
                    }
                ...
                case 2:
                    ...
                    if(m==1)
                    {
                        ...
                        if(t=="S"||t=="s")
                        {
                            ...
                            Console.WriteLine("Customer has opened a savings account");
                        }
                        else if(t=="C"||t=="c")
                        {
                            Console.WriteLine("Enter the Account Number ");
                            ...
                            Console.WriteLine("Customer has opened a checking account");
